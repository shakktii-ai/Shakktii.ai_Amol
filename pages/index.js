...
//         डेमो मतदानासाठी शेतकरी निशाणी समोरील निळे बटन दाबावे
//     </button>
//     <p className="text-md font-medium mt-6">
//         मतदानाच्या दिवशी सुद्धा <span className="font-bold">शेतकरी</span> या चिन्हासमोरील बटन दाबून <span className="font-bold">भरत मारुती गोगावले</span> यांना प्रचंड मतांनी विजयी करा !
//     </p>
...
//         “शेतकरी” या चिन्हासमोरील बटन दाबून प्रचंड मतांनी विजयी करा.
//     </p>
...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>श्री.अमोल पंडितराव शिंदे.</title>
      ...
      <div className="p-4 bg-white max-w-xl mx-auto text-center">
        <h1 className="text-lg font-semibold text-blue-800">
        018- पाचोरा विधानसभा सार्वत्रिक निवडणूक 2024
        </h1>
        ...
        <p className="text-md font-medium mt-6">
          मतदानाच्या दिवशी सुद्धा <span className="font-bold">शेतकरी</span> या
          चिन्हासमोरील बटन दाबून{" "}
          <span className="font-bold">श्री.अमोल पंडितराव शिंदे</span> यांना प्रचंड मतांनी
          विजयी करा !
        </p>
        <div className="flex justify-center mt-6 ">
          <button
      ...
      <tr>
              <td className="border-2 border-black p-2 text-center text-xl font-bold">७.</td>
              <td className="border-2 border-black text-center text-sm font-bold w-65">
              श्री.अमोल पंडितराव शिंदे.
              </td>
              <td className="border-2 border-black text-center w-16">
                <img src="/Amol.jpg" className=" m-auto" />
              </td>
              <td className="border-2 border-black text-center w-16">
                <img src="/farmer.svg" className=" m-auto" />
              </td>
    ...
    <span className="flex items-center">
      ...
      <audio ref={(el) => (audioRefs.current.audio2 = el)} src="/amol.mp3" preload="auto"></audio>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-70 flex flex-col justify-center items-center z-50">
                  <div className="relative">
                    ...
                    <img src='/Amol.gif' alt="Full-screen" className="max-w-full max-h-full" />
                  </div>
                  <div>
                  {/* <a href="https://wa.link/92x71l">
                <button className="bg-green-500 text-white font-bold py-2 px-4 rounded-full flex items-center space-x-2">
